        ...
        <div class="bg-white shadow-md rounded my-6 p-5">
          <form method="POST" action="{{ route('admin.categories.update',$category->id)}}">
            ...
            <div class="flex flex-col space-y-2">
              <label for="title" class="text-gray-700 select-none font-medium"><span
                  class="text-red-600">*</span>Title</label>
            ...
            <div class="grid grid-cols-3 gap-4">
              <div class="relative inline-flex">
                ...
                <select
                  ...
                  <option value="1" @if($category->status) selected @endif>Publish</option>
                </select>
                @error('status')
                <span class="text-red-600  pt-5 pl-5">{{ $message }}</span>
                @enderror
