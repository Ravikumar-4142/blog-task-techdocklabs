...
@endcanany
        ...
        @endcanany
        @canany('Post access','Post add','Post edit','Post delete')
        <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Route::currentRouteNamed('admin.comments.index') ? 'active' : '' }}"
            ...
            <span class="mx-3">Post Commments</span>
        </a>
        @endcanany
